...
import org.opencron.common.util.SystemClock;
import org.opencron.transport.api.ProtocolHeader;
import org.opencron.transport.api.exception.IoSignals;
...
public class ProtocolDecoder extends ReplayingDecoder<ProtocolDecoder.State> {
    ...
    // 协议体最大限制, 默认5M
    private static final int MAX_BODY_SIZE = SystemPropertyUtil.getInt("opencron.io.decoder.max.body.size", 1024 * 1024 * 5);
     ...
     */
    private static final boolean USE_COMPOSITE_BUF = SystemPropertyUtil.getBoolean("opencron.io.decoder.composite.buf", false);
