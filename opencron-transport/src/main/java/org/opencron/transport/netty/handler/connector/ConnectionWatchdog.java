...
import org.opencron.transport.netty.handler.ChannelHandlerHolder;
...
public abstract class ConnectionWatchdog extends ChannelInboundHandlerAdapter implements TimerTask, ChannelHandlerHolder {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        logger.info("[opencron] Connects with {}.", ch);
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        logger.warn("[opencron] Disconnects with {}, address: {}, reconnect: {}.", ctx.channel(), remoteAddress, doReconnect);
    ...
    public void run(Timeout timeout) throws Exception {
        if (!isReconnectNeeded()) {
            logger.warn("[opencron] Cancel reconnecting with {}.", remoteAddress);
            return;
        }
        ...
        future.addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture f) throws Exception {
                ...
                logger.warn("[opencron] Reconnects with {}, {}.", remoteAddress, succeed ? "succeed" : "failed");
